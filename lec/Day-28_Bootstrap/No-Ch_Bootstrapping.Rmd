...
- We did this when the data met certain assumptions, including having a SRS and that
...
- We couldn't use the regular formula for calculating the confidence interval because we don't know how to calculate the standard error for these other parameters. We only know right now how to calculate the standard error for the mean. 
...
- Two other methods are known as i) the **basic or empirical bootstrap** and ii) the **bias-corrected and accelerated bootstrap**
