...
This is what is know as the **large sample confidence interval for a population proportion**

### But...

- This confidence interval does not perform well, meaning that if we repeated the confidence interval 100 times (based on 100 random samples), less than 95 of the 95% confidence intervals would contain the true value for the proportion $p$. We say that this method has poor **coverage** because it contains the true propability $p$ less than it should
- To overcome this, we will modify how we calculate the confidence interval slightly using what is known as the "plus 4 method"
