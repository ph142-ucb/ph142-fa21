...
subtitle: 'Assumptions for inference and diagnostic plots'
...
2. $y$ varies Normally around the line of best fit. Said differently, the **residuals** vary Normally
...
Assumption 2 says that the lengths of these residuals are Normally distributed.

**Important note:** This assumption does not say that $y$ is normally distributed or that $x$ is normally distributed! Many people on the Internet get this assumption wrong, so beware of this incorrect interpretations.
