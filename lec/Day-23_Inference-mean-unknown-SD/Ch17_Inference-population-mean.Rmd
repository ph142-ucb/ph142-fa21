---
title: "Chapter 17: Hypothesis Tests for a Mean with a Unknown Standard Deviation"
...
- Observations follow a Normal distribution (some leeway thanks to the CLT)
...
distribution that is like the standard Normal but a little bit wider (i.e., more
...
The one-sample t statistic has a t distribution with $n-1$ **degrees of freedom (df)**
