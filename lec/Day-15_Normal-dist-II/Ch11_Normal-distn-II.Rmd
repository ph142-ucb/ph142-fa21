---
title: "The Normal Distribution continued"
...
percentile of the fata each value occupies. For example, the smallest observation
in a set of 20 is at the 5% point, the second smallest is at the 10% point, and 
so on.

2. Do Normoal distribution calculations to find z-scored at these same percentiles. For example, z = -1.645 is the 5% point of the standard Normal 
...
Once we log tranformed the data, the values now follow a Normal distribution
