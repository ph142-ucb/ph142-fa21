...
* This is the correct test. It accounts for the **paired** nature of the data. How does the test statistics (`t`), the p-value, and the degrees of freedom change from the previous output?
...
- The relative difference is <1 which indicates more events in the 9-18th day after vaccination vs. the 0-3rd day.
