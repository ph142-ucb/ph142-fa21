...
* [Interpreting Correlation Coefficients](https://learningstatisticswithr.com/lsr-0.6.pdf) (See section 5.7.4) 
...
```{r import-nhanes}
# students, you do not need to be familiar with this chunk of code to read in XPT data.
...
```{r updated-scatter, out.width="60%"}
