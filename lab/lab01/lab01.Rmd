...
### Instructions 
* Due date: Friday, August 27th, 11:59pm.
...
You must create a password for your gradescope account: 
...
**It is important to save changes so your new password stays saved.**
...
cd; cd ph142-fa21/lab/lab01; python3 turn_in.py

3. Follow the prompts to enter your Gradescope username and password.
<<<<<<< HEAD
4. If the submission is successful, you should see "Submission successful!" appear as output.
=======
4. If the submission is successful, you should see "Submission successful!" appear as the output.
>>>>>>> kelsey-lab01
