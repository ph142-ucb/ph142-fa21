...
### Instructions 
* Due date: Friday, September 10th by 11:59pm PST.
...
**2. [1 point] Using the `mutate()` function, add two new logged variables to the `CS_data` dataset and assign this new dataset to `CS_data_log`. Call the variables `log_CS` and `log_GDP`. Use base e, also known as natural logarithms, to create the logged variables.**
...
cd; cd ph142-fa21/lab/lab03; python3 turn_in.py
